@echo off
:: SysInfo_Collector_CMD.bat  v2.1
...
:: Double-click or: SysInfo_Collector_CMD.bat
:: ============================================================
...
cls
echo +----------------------------------------------------------+
echo ^|  SysInfo Collector v2.1  (Universal CMD Edition)        ^|
...
echo ============================================================== > "%OUT%"
echo   SYSTEM INFORMATION REPORT  v2.1  (CMD Universal Edition) >> "%OUT%"
echo ============================================================== >> "%OUT%"
